...
public class ScaleGestureDetector {
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        @Override // com.gallery.photos.editphotovideo.eraser.eraser.ScaleGestureDetector.OnScaleGestureListener
    ...
    public boolean onTouchEvent(View view, MotionEvent motionEvent) {
        ...
        if (pointerCount > 2) {
            ...
            if (pointerId2 == i) {
                ...
                if (pointerId2 == this.mActiveId1 && (findNewActiveIndex = findNewActiveIndex(motionEvent, i, actionIndex2)) >= 0) {
                    this.mListener.onScaleEnd(view, this);
