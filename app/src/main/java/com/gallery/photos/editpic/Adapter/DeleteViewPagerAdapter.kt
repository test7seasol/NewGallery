...
class DeleteViewPagerAdapter(private val context: Context, private val imageList: ArrayList<DeleteMediaModel>) :
    RecyclerView.Adapter<DeleteViewPagerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bind(imageList[position].binPath)
    }
