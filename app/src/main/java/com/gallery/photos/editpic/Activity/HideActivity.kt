            ...
            llMore.onClick {
                val hideDialog = HideItemsBottomPopup(this@HideActivity) {
                    when (it) {
                        ...
                        "llUnHideAll" -> {
                            if (!hasAllFilesAccessAs(this@HideActivity)) {
                                (getString(R.string.all_files_access_required)).tos(this@HideActivity)
                                AllFilesAccessDialog(this@HideActivity){

                                }
//                                startActivityWithBundle<AllFilePermissionActivity>(Bundle().apply {
//                                    putString("isFrom", "Activitys")
//                                })
                                return@HideItemsBottomPopup
                            }
