...
public class GradientRatioAdapter extends RecyclerView.Adapter<GradientRatioAdapter.ViewHolder> {
    ...
    public GradientRatioAdapter(Context context, BackgroundInstaListener backgroundInstaListener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view) {
            super(view);
            this.imageViewSelected = (ImageView) view.findViewById(R.id.imageSelection);
