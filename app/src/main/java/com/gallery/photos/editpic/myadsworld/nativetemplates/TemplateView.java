package com.gallery.photos.editpic.myadsworld.nativetemplates;
...
/**
 * Base class for a template binding. *
 */
public class TemplateView extends FrameLayout {
    ...
    public void setNativeAd(NativeAd nativeAd, String buttonColor) {
        ...
        //  Set the secondary binding to be the star rating if available.
...
//      ratingBar.setVisibility(VISIBLE);
     ...
     * method does not destroy the template binding.
