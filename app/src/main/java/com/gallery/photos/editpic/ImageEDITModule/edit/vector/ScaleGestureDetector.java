package com.gallery.photos.editpic.ImageEDITModule.edit.vector;
...
public class ScaleGestureDetector {
    ...
    public static class SimpleOnScaleGestureListener implements OnScaleGestureListener {
        @Override // com.gallery.photos.editphotovideo.vector.ScaleGestureDetector.OnScaleGestureListener
    ...
    private void setContext(View view, MotionEvent motionEvent) {
        ...
        float x2 = motionEvent3.getX(findPointerIndex2) - x;
        float y2 = motionEvent3.getY(findPointerIndex2) - y;
