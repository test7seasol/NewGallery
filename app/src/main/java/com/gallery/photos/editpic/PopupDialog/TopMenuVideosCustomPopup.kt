...
import com.gallery.photos.editpic.databinding.ToptoolVideospopupdialogBinding
import com.labo.kaji.relativepopupwindow.RelativePopupWindow

class TopMenuVideosCustomPopup(
    private val activity: Activity, var onClick: (String) -> Unit
) {
    private var popupWindow: RelativePopupWindow? = null
    var binding: ToptoolVideospopupdialogBinding =
        ToptoolVideospopupdialogBinding.inflate(LayoutInflater.from(activity))
