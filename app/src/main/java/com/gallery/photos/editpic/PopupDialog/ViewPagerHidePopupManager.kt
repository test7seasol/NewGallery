...
import com.gallery.photos.editpic.databinding.ToptoolViewpagerpopupdialogBinding
import com.labo.kaji.relativepopupwindow.RelativePopupWindow

class ViewPagerHidePopupManager(
    private val activity: Activity, var onClick: (String) -> Unit
) {
    private var popupWindow: RelativePopupWindow? = null
    var binding: ToptoolViewpagerpopupdialogBinding =
        ToptoolViewpagerpopupdialogBinding.inflate(LayoutInflater.from(activity))
