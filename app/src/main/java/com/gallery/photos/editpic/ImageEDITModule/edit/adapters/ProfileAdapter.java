...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.ViewHolder> {
    public ProfileItemListener clickListener;
    Context mContext;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Glide.with(this.mContext).load("file:///android_asset/card/" + this.pixLabItemList.get(i) + ".webp").fitCenter().into(viewHolder.mIvImage);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            int i = ProfileAdapter.this.selectedPos;
            ProfileAdapter.this.selectedPos = getAdapterPosition();
            ProfileAdapter.this.notifyItemChanged(i);
            ProfileAdapter profileAdapter = ProfileAdapter.this;
            profileAdapter.notifyItemChanged(profileAdapter.selectedPos);
            ProfileAdapter.this.clickListener.onProfileListClick(view, getAdapterPosition());
        }
    }
}
