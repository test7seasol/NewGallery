...
public class MyAddPrefs {
    ...
    public void setAdmInlineBannerId(String sid) {
        editor.putString("inline_banner", sid).commit();
    }

    public String getAdmInlineBannerId() {
        return prefs.getString("inline_banner", "ca-app-pub-3940256099942544/6300978111");
    }
