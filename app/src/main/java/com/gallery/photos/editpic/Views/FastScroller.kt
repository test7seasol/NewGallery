package com.gallery.photos.editpic.Views
...
import com.gallery.photos.editpic.Views.extension.compatPaddingStart
import com.gallery.photos.editpic.Views.extension.firstVisibleItemPosition
import com.gallery.photos.editpic.Views.extension.getCompatDrawable
import com.gallery.photos.editpic.Views.extension.isLayoutReversed
import com.gallery.photos.editpic.Views.extension.setCompatTint
import com.gallery.photos.editpic.Views.extension.wrap
...
class FastScroller : LinearLayout {
    ...
    enum class Size(@DrawableRes val drawableId: Int, @DimenRes val textSizeId: Int) {
        NORMAL(R.drawable.contacts_fastscroller_drawable, R.dimen.fastscroll_bubble_text_size),
    ...
    fun setCustomHandleDrawable(drawable: Drawable) {
        handleView.setImageDrawable(drawable) // 'handle' refers to the ImageView used for the handle
    }
