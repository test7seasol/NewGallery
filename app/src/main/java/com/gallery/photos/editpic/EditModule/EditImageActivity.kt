package com.gallery.photos.editpic.EditModule
...
import com.gallery.photos.editpic.EditModule.EmojiBSFragment.EmojiListener
import com.gallery.photos.editpic.EditModule.StickerBSFragment.StickerListener
import com.gallery.photos.editpic.EditModule.base.BaseActivity
import com.gallery.photos.editpic.EditModule.filters.FilterListener
import com.gallery.photos.editpic.EditModule.filters.FilterViewAdapter
import com.gallery.photos.editpic.EditModule.tools.EditingToolsAdapter
import com.gallery.photos.editpic.EditModule.tools.EditingToolsAdapter.OnItemSelected
import com.gallery.photos.editpic.EditModule.tools.ToolType
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* val imagePath = intent.getStringExtra("IMAGE_PATH")
        if (imagePath != null) {
            ...
            mPhotoEditorView.source.setImageResource(R.drawable.paris_tower) // Default fallback
        }*/

        mPhotoEditorView.source.scaleType = ImageView.ScaleType.FIT_CENTER
